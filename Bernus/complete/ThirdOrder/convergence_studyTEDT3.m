...
%[Vref,tref, I_Naref,I_Caref,I_toref, I_Kref,I_K1ref,I_Nabref,I_Cabref,I_NaKref,I_NaCaref]=bernus_AB2AM3_also_gating(2^15); 
 ...
 [Vcc,tcc]=bernus_TEDT3(2^2);2 %,Vref,tref, I_Naref,I_Caref,I_toref, I_Kref,I_K1ref,I_Nabref,I_Cabref,I_NaKref,I_NaCare
 [Vc,tc]=bernus_TEDT3(2^3);3
 
 [Vm,tm]=bernus_TEDT3(2^4);4
 [Vg,tg]=bernus_TEDT3(2^5);5
 [Vb,tb]=bernus_TEDT3(2^6);6
 [Vr,tr]=bernus_TEDT3(2^7);7
 [Vf,tf]=bernus_TEDT3(2^8);8
...
semilogy(oneovertau(1:7),Errors,'m');
...
figure(2)
hold on
semilogy(oneovertau(1:6),Ratios,'m');
