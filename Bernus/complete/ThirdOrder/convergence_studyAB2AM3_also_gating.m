...
%[Vref,tref, I_Naref,I_Caref,I_toref, I_Kref,I_K1ref,I_Nabref,I_Cabref,I_NaKref,I_NaCaref]=bernus_AB2AM3_also_gating(2^15); 
 ...
 [Vcc,tcc]=bernus_AB2AM3_also_gating(2^2);
 [Vc,tc]=bernus_AB2AM3_also_gating(2^3);
 
 [Vm,tm]=bernus_AB2AM3_also_gating(2^4);
 [Vg,tg]=bernus_AB2AM3_also_gating(2^5);
 [Vb,tb]=bernus_AB2AM3_also_gating(2^6);
 [Vr,tr]=bernus_AB2AM3_also_gating(2^7);
 [Vf,tf]=bernus_AB2AM3_also_gating(2^8);
