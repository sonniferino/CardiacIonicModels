...
%  toc
%
[Vi,ti,vi,mi,fi,toi,Xi]=bernus_IFAM3(2^0,tref,Vref);
[Vccc,tccc,vccc,mccc,fccc,toccc,Xccc]=bernus_IFAM3(2^1,tref,Vref);1
[Vcc,tcc,vcc,mcc,fcc,tocc,Xcc]=bernus_IFAM3(2^2,tref,Vref);2
[Vc,tc,vc,mc,fc,toc,Xc]=bernus_IFAM3(2^3,tref,Vref);3
[Vm,tm,vm,mm,fm,tom,Xm]=bernus_IFAM3(2^4,tref,Vref);4
[Vg,tg,vg,mg,fg,tog,Xg]=bernus_IFAM3(2^5,tref,Vref);5
[Vb,tb,vb,mb,fb,tob,Xb]=bernus_IFAM3(2^6,tref,Vref);6
[Vr,tr,vr,mr,fr,tor,Xr]=bernus_IFAM3(2^7,tref,Vref);7
[Vf,tf,vf,mf,ff,tof,Xf]=bernus_IFAM3(2^8,tref,Vref);8
%[Vff,tff,vff,mff,fff,toff,Xff]=bernus_IFAM3(2^9,tref,Vref);
%[Vfff,tfff,vfff,mfff,ffff,tofff,Xfff]=bernus_IFAM3(2^10,tref,Vref);
%[Vsf,tsf,vsf,msf,fsf,tosf,Xsf]=bernus_IFAM3(2^11,tref,Vref);
% 
