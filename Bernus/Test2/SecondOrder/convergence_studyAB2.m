...
%  toc
%
[Vi,ti,vi,mi,fi,toi,Xi]=bernus_AB2(2^0,tref,Vref);
[Vccc,tccc,vccc,mccc,fccc,toccc,Xccc]=bernus_AB2(2^1,tref,Vref);
[Vcc,tcc,vcc,mcc,fcc,tocc,Xcc]=bernus_AB2(2^2,tref,Vref);
[Vc,tc,vc,mc,fc,toc,Xc]=bernus_AB2(2^3,tref,Vref);
[Vm,tm,vm,mm,fm,tom,Xm]=bernus_AB2(2^4,tref,Vref);
[Vg,tg,vg,mg,fg,tog,Xg]=bernus_AB2(2^5,tref,Vref);
[Vb,tb,vb,mb,fb,tob,Xb]=bernus_AB2(2^6,tref,Vref);
[Vr,tr,vr,mr,fr,tor,Xr]=bernus_AB2(2^7,tref,Vref);
[Vf,tf,vf,mf,ff,tof,Xf]=bernus_AB2(2^8,tref,Vref);
[Vff,tff,vff,mff,fff,toff,Xff]=bernus_AB2(2^9,tref,Vref);
[Vfff,tfff,vfff,mfff,ffff,tofff,Xfff]=bernus_AB2(2^10,tref,Vref);
[Vsf,tsf,vsf,msf,fsf,tosf,Xsf]=bernus_AB2(2^11,tref,Vref);
% 
...
subplot(2,5,1)
hold on
Errors=[E2,E3,E4,E5,E6,E7,E8,E9,E10,E11]
semilogy(oneovertau(3:12),Errors,'r--');
...
Ratios=[R2,R3,R4,R5,R6,R7,R8,R9,R10]
subplot(2,5,6)
hold on
semilogy(oneovertau(3:11),Ratios,'r--');
...
hold on
Errors=[E9,E10,E11]
semilogy(oneovertau(10:12),Errors,'r--');
%legend('Error for gating v')
...
subplot(2,5,7)
hold on
semilogy(oneovertau(10:11),Ratios,'r--');
