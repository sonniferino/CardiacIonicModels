function [u,t,v,m,f,to,X]=bernus_AB2(num_steps,tref,Vref)  
...
for i=3:length(t)
    ...
    vn= vo+tau*((3/2)*(Lo*vo+No)-(1/2)*(Lolder*volder+Nolder)); %AB2
    ...
    mn= mo+tau*((3/2)*(Lo*mo+No)-(1/2)*(Lolder*molder+Nolder)); %AB2
    ...
    fn= fo+tau*((3/2)*(Lo*fo+No)-(1/2)*(Lolder*folder+Nolder)); %AB2
    ...
    ton= too+tau*((3/2)*(Lo*too+No)-(1/2)*(Lolder*toolder+Nolder)); %AB2
    ...
    Xn= Xo+tau*((3/2)*(Lo*Xo+No)-(1/2)*(Lolder*Xolder+Nolder)); %AB2
