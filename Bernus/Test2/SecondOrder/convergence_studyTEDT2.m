...
%  toc
%
[Vi,ti,vi,mi,fi,toi,Xi]=bernus_TEDT2(2^0,tref,Vref);
[Vccc,tccc,vccc,mccc,fccc,toccc,Xccc]=bernus_TEDT2(2^1,tref,Vref);
[Vcc,tcc,vcc,mcc,fcc,tocc,Xcc]=bernus_TEDT2(2^2,tref,Vref);
[Vc,tc,vc,mc,fc,toc,Xc]=bernus_TEDT2(2^3,tref,Vref);
[Vm,tm,vm,mm,fm,tom,Xm]=bernus_TEDT2(2^4,tref,Vref);
[Vg,tg,vg,mg,fg,tog,Xg]=bernus_TEDT2(2^5,tref,Vref);
[Vb,tb,vb,mb,fb,tob,Xb]=bernus_TEDT2(2^6,tref,Vref);
[Vr,tr,vr,mr,fr,tor,Xr]=bernus_TEDT2(2^7,tref,Vref);
[Vf,tf,vf,mf,ff,tof,Xf]=bernus_TEDT2(2^8,tref,Vref);
[Vff,tff,vff,mff,fff,toff,Xff]=bernus_TEDT2(2^9,tref,Vref);
[Vfff,tfff,vfff,mfff,ffff,tofff,Xfff]=bernus_TEDT2(2^10,tref,Vref);
[Vsf,tsf,vsf,msf,fsf,tosf,Xsf]=bernus_TEDT2(2^11,tref,Vref);
% 
...
semilogy(oneovertau(1:12),Errors,'m');
...
semilogy(oneovertau(1:11),Ratios,'m');
